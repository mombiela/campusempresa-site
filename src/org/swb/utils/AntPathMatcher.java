 ...
 * href="http://ant.apache.org">Apache Ant</a> and <a href="http://www.springsource.org">SpringSource</a>.
 * 
 * <p>
...
public class AntPathMatcher
{
    ...
    private static boolean doMatch(String pattern, String path, boolean fullMatch)
    {
        ...
        if (pathIdxStart > pathIdxEnd)
        {
            ...
            {
                return (pattern.endsWith(PATH_SEPARATOR) ? path.endsWith(PATH_SEPARATOR) : !path.endsWith(PATH_SEPARATOR));
            }
            if (!fullMatch)
            {
                return true;
